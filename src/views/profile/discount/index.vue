        ...
        <transition
          ...
          <div v-if='activeName === "1"'>
            <div class='container'>
              ...
              <div class='item' v-for='item of envelopes' :key='item.id'>
                <div class='item-container'>
                  <div class='price'>
                    <div class='title'>￥<span>{{ item.amount.toFixed(1) }}</span></div>
            ...
            <div class='history-btn'>查看历史红包 ></div>
            <div class='tabbar'>
              <div>兑换红包</div>
              <div>推荐有奖</div>
            </div>
        ...
        <transition
          ...
          <div v-if='activeName ==="2"' class='container flex flex-col'>
            ...
            <div class='flex mt-20 flex-1 flex-col items-center justify-center'>
              ...
              <van-button color='#79ce7f' size='small'>下载或升级客户端</van-button>
            </div>
          </div>
        </transition>
      </van-tab>
...
.discount-container {
  @apply pt-[46px] bg-[#f5f5f5] min-h-screen;
  .container {
    @apply p-4;
    > .title {
